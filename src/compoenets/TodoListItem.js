...
export default class TodoListItem extends React.Component {
    ...
    renderCompletedTableItem(date, status, dp_url) {
        ...
        return (
            <div className="todoListCompletedItem">
                <div>
                    <Header as='h6' image>
    ...
    renderExtraContent() {
        ...
        return (
            <Accordion styled>
                <Accordion.Title className="todoListCompletedAccorianTitle" content='Already Completed' index={0}
                                 onClick={this.handleClick}/>
                <Accordion.Content className='todoListCompletedAccorianTable' active={activeIndex === 0}
                                   content={completedTable}/>
            </Accordion>
        )
